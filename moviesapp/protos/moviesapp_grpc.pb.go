...
type MovieClient interface {
	...
	GetMovie(ctx context.Context, in *ID, opts ...grpc.CallOption) (*MoviesInfo, error)
	CreateMovie(ctx context.Context, in *MoviesInfo, opts ...grpc.CallOption) (*ID, error)
	UpdateMovie(ctx context.Context, in *MoviesInfo, opts ...grpc.CallOption) (*Status, error)
...
func (x *movieGetMoviesClient) Recv() (*MoviesInfo, error) {
	m := new(MoviesInfo)
...
func (c *movieClient) GetMovie(ctx context.Context, in *ID, opts ...grpc.CallOption) (*MoviesInfo, error) {
	out := new(MoviesInfo)
...
func (c *movieClient) CreateMovie(ctx context.Context, in *MoviesInfo, opts ...grpc.CallOption) (*ID, error) {
	out := new(ID)
...
func (c *movieClient) UpdateMovie(ctx context.Context, in *MoviesInfo, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
...
type MovieServer interface {
	...
	GetMovie(context.Context, *ID) (*MoviesInfo, error)
	CreateMovie(context.Context, *MoviesInfo) (*ID, error)
	UpdateMovie(context.Context, *MoviesInfo) (*Status, error)
...
func (UnimplementedMovieServer) GetMovie(context.Context, *ID) (*MoviesInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMovie not implemented")
}
func (UnimplementedMovieServer) CreateMovie(context.Context, *MoviesInfo) (*ID, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateMovie not implemented")
}
func (UnimplementedMovieServer) UpdateMovie(context.Context, *MoviesInfo) (*Status, error) {
...
func (x *movieGetMoviesServer) Send(m *MoviesInfo) error {
...
func _Movie_CreateMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServer).CreateMovie(ctx, req.(*MoviesInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Movie_UpdateMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServer).UpdateMovie(ctx, req.(*MoviesInfo))
	}
	return interceptor(ctx, in, info, handler)
}
