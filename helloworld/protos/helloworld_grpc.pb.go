...
type HelloWorldClient interface {
	EchoHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *helloWorldClient) EchoHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/helloworld.HelloWorld/EchoHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloWorldServer interface {
	EchoHello(context.Context, *HelloRequest) (*HelloResponse, error)
...
func (UnimplementedHelloWorldServer) EchoHello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _HelloWorld_EchoHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWorldServer).EchoHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.HelloWorld/EchoHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).EchoHello(ctx, req.(*HelloRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _HelloWorld_EchoHello_Handler,
		},
	},
